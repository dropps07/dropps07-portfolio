...
"size-[30px] bg-slate-500 flex justify-center items-center rounded-[9px] transition-all overflow-hidden hover:bg-slate-400 duration-300 shadow"
            ...
            <div className = "flex flex-col justify-between w-full rounded-[10px] overflow-hidden h-full">
                <div className = "bg-slate-800 h-fit w-full p-[8px] flex flex-row justify-between items-center">
                    ...
                    <div className = "flex-1 flex flex-row justify-center">
                        <div className = "text-slate-300 whitespace-nowrap tracking-tighter">terminal</div>
                    </div>
                ...
                <div className = "h-full rounded-[8px] w-full bg-[#1a1b26] pl-[24px] p-[8px] text-slate-300 flex flex-row justify-between">
                    ...
                    <div className = "pl-[8px] text-slate-200 tracking-tighter w-full">
                        ...
                        I am a software developer based in UttarPradesh with years of programming experience with a diverse portfolio<br />
