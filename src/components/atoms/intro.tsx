...
const Intro = () => {
    return (
        <div className="max-w-[1250px] w-full bg-white rounded-[24px] flex xl:flex-row xl:justify-between flex-col md:p-[32px] sm:p-[24px]
         p-[12px] shadow-lg hover:shadow-2xl transition-all duration-300 xl:gap-0 gap-[24px]">
