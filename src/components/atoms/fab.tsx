    ...
    return(
        <div className={`p-[16px] ${font.className}`}>
            <div className="rounded-[16px] border-[1px] shadow-lg transition-all hover:shadow-2xl duration-300 bg-white">
                ...
                <button
                onClick={openPopup}
                className="bg-[#202124] md:border-[4px] border-[2px] border-[#202124] sm:hover:border-black active:border-black hover:text-black hover:bg-white
                transition-all durration-300 hover:-translate-y-1 text-white py-[10px] px-[20px] rounded-[12px] font-extrabold whitespace-nowrap">
                    Get In touch!
                </button>
            </div>
        </div>
